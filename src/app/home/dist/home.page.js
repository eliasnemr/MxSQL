...
var HomePage = /** @class */ (function () {
    function HomePage(formBuilder, mService) {
    ...
    HomePage.prototype.runQuery = function (_q) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mService.sql(_q)];
                    case 1:
                        res = _a.sent();
                        // console.log(res);
    ...
    Object.defineProperty(HomePage.prototype, "query", {
        get: function () {
    ...
    __decorate([
        core_1.ViewChild('queryTextArea', { static: false })
    ], HomePage.prototype, "queryTextArea");
    HomePage = __decorate([
        core_1.Component({
            selector: 'app-home',
